...
<head>
    ...
    <title>Activation de votre compte - Simplon Africa</title>
</head>
                    ...
                    <tr>
                        <td style="padding: 0 40px 40px;">
                            ...
                            <p style="margin: 0 0 16px; font-size: 16px; line-height: 1.6; color: #374151;">
                                Votre compte {{ $roleLabel }} a été créé sur la plateforme Simplon Africa.
                            </p>
                            ...
                            <table role="presentation" style="width: 100%; margin: 32px 0;">
                                <tr>
                                    <td style="text-align: center;">
                                        <a href="{{ $activationUrl }}" style="display: inline-block; padding: 14px 32px; background-color: #dc2626; color: #ffffff; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 16px; box-shadow: 0 2px 4px rgba(220, 38, 38, 0.3);">
