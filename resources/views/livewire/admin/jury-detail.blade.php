                            ...
                            <div class="border-l-4 {{ $presidentInfo['all_members_evaluated'] ? 'border-l-green-500' : 'border-l-yellow-500' }}">
                                ...
                                >
                                    <div class="flex items-center gap-4">
                                        ...
                                        <!-- Infos -->
                                        <div class="text-left">
                                            <h4 class="font-semibold text-gray-900">{{ $candidature->user->name }}</h4>
                                ...
                                >
                                    ...
                                    @if($presidentInfo['all_members_evaluated'])
                                        <form action="{{ route('admin.jury.president-validate', ['jury' => $jury->id, 'candidature' => $candidature->id]) }}" method="POST" class="space-y-4">
                                            @csrf
                                            ...
                                            <div class="flex flex-wrap items-center gap-3">
                                                <button
                                                    ...
                                                    name="decision"
                                                    value="approved"
                                                    class="inline-flex items-center gap-2 px-5 py-2.5 bg-green-600 text-white rounded-lg hover:bg-green-700 transition font-semibold text-sm"
                                                >
                                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                ...
                                                <button
                                                    ...
                                                    name="decision"
                                                    value="rejected"
                                                    class="inline-flex items-center gap-2 px-5 py-2.5 bg-red-600 text-white rounded-lg hover:bg-red-700 transition font-semibold text-sm"
                                                >
                                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
